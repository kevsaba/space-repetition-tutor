 ...
 *
 * Allows users to upload a PDF file containing interview questions
...
export function PDFUploader({ onSuccess, onCancel, className = '' }: PDFUploaderProps) {
  const [careerName, setCareerName] = useState('');
  const [file, setFile] = useState<File | null>(null);
  const [uploading, setUploading] = useState(false);
  const [progress, setProgress] = useState(0);
  const [error, setError] = useState('');
  const [success, setSuccess] = useState<PDFUploadResult | null>(null);
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Upload PDF Questions</h3>
              <p className="text-sm text-gray-500">Create a custom career path from your PDF</p>
            </div>
          </div>
          {onCancel && !success && (
            <button
            ...
            {uploading && (
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-xs text-gray-500 mt-2">
                  Processing your PDF and extracting questions...
                </p>
              </div>
            )}
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <ul className="text-sm text-blue-700 mt-1 space-y-1">
                    <li>• Upload a PDF with interview questions</li>
                    <li>• We'll extract topics and questions automatically</li>
                    <li>• Questions are added to your Leitner boxes for practice</li>
                  </ul>
                </div>
              </div>
            </div>
